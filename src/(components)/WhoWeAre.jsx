    ...
    <section ref={sectionRef} className="WWAContainer">
      <div className="WWA">
        ...
        <span className={`WWAText scroll-fade-in-delay-1 ${isSectionVisible ? 'visible' : ''}`}>
          ...
          <p>
            Jodna Technologies is a full-service technology company specializing in web development, 
            mobile applications, desktop software, and database management. We combine technical 
            expertise with business acumen to deliver solutions that drive growth and innovation.
          </p>
